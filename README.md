...
&nbsp;&nbsp;&nbsp;&nbsp;d.	[Install necessary python packages](#d.-install-opencv)  
&nbsp;&nbsp;&nbsp;&nbsp;e.	[Install necessary python packages](#e.-download-tracktor)  
&nbsp;&nbsp;&nbsp;&nbsp;f.	[Install necessary python packages](#f.-open-a-jupyter-notebook)  
&nbsp;&nbsp;&nbsp;&nbsp;g.	[Install necessary python packages](#g.-runnung-the-example-code)  
&nbsp;&nbsp;&nbsp;&nbsp;h.	[Install necessary python packages](#h.-running-tracktor-on-your-videos)  
